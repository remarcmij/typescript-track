...
- Annotate variables, function parameters, and return types with TypeScript's type system.
- Type arrays and objects, and know when to reach for interfaces or type aliases.
- Extend and compose types using unions, intersections, and interface inheritance.
- Write generic functions and interfaces that work with any type while staying type-safe.
- Know when to let TypeScript infer types and when to add an explicit annotation.
